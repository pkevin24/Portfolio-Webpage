...
function Navbar1() {
    return (
        ...
        <Navbar.Brand href="/"><img src="/Images/lo1.jpg" alt="img" width="100px" style={{borderRadius:"20px"}}></img></Navbar.Brand>
        ...
        <Navbar.Collapse  className="nav1" id="basic-navbar-nav" style={{padding: "0.5rem 2rem"}}>
          <Nav className="mr-auto" style={{paddingRight: "1rem"}} >
            ...
            <NavLink style={{color:"black", fontWeight:"900",fontFamily:"'Bebas Neue', cursive"}} exact activeClassName='active_class' to='/'><span className="n1" style={{marginRight:"45px"}}>Home</span></NavLink>
              <NavLink style={{color:"black", fontWeight:"900",fontFamily:"'Bebas Neue', cursive"}} exact activeClassName='active_class' to='/project'><span className="n1" style={{marginRight:"45px"}}>Project</span></NavLink>
              ...
              <NavLink style={{color:"black", fontWeight:"900",fontFamily:"'Bebas Neue', cursive"}} exact activeClassName='active_class' to='/contactfeedback'><span className="n1" style={{marginRight:"45px"}}>Contact</span></NavLink>
            </Fade>
