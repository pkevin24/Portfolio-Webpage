 ...
 */}
    ...
    <Col>
    <Form.Label style={{fontSize:"20px"}}>Any feedback</Form.Label>
    <textarea rows="4" cols="45" name="comment" form="usrform" placeholder="Enter text here...">
</textarea>
    </Col>
    
    <Col><Link to="/" className="btn btn-primary" style={{marginLeft:"140px"}}>
     Submit
    </Link></Col>
